...
public class ReviewController {
    ...
    public ApiResponse<ReviewResponseDTO.ReviewPreViewListDTO> getReviewsByUser(@RequestParam(name = "page") Integer page, @RequestParam(name="memberId") Long memberId){
